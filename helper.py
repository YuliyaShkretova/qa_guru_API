    ...
    def request(self, method, url, *args, **kwargs) -> Response:
        ...
        with step(f'{method} {url}'):
            if response.text is not None:
                allure.attach(body=total_data, name="Request curl", attachment_type=AttachmentType.TEXT, extension='txt')
            else:
                allure.attach(body=total_data, name="Request curl", attachment_type=AttachmentType.JSON, extension='json')
